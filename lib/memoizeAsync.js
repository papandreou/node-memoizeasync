    ...
    return function memoizeAsync(lambda, options) {
        ...
        function memoizer() { // ...
            ...
            if (typeof resultCallbackParams !== 'undefined') {
                if (getAge.apply(null, args) > options.refreshAge && !waitingCallbacksByStringifiedArguments[stringifiedArguments]) {
                    waitingCallbacksByStringifiedArguments[stringifiedArguments] = [function () {}];
                    updateCache = true;
                }
                defer(function () {
        ...
        var getAge = memoizer.getAge = function () {
            var entry = cache._cache[cacheKeyPrefix + argumentsStringifier(Array.prototype.slice.call(arguments))];
            if (!entry) {
                return -1;
            }
